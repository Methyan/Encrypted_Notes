...
int WinDosyaVarlikKontrol (void);
...
void GelistiriciMenu17Fonk (void);
...
int main() {
    ...
    while (1) {
        ...
        if (secim == 49) {
            ...
            if (control == 1){
                printf("\n\n--> Degisikliklerin uygulanmasi icin program kapatilacak.\n");
            ...
            while (1) {
                ...
                if (control == 0) {
                    ...
                    system("cls");
                    printf("\n--> Degisiklerin uygulanmasi icin program kapatilacak!\n\n");
                    printf("\nDevam etmek icin ENTER'a basin.");
                    getchar();
                    system("cls");
                    return 0;
            ...
            while (1) {
                ...
                else if (secim == 72) GelistiriciMenu17Fonk();   // WinDosyaVarlikKontrol.
...
liste * DosyaListele (void) {
    FILE *dosya1 = fopen("/Users/Public/.qwe.qwe", "r");
    FILE *dosya2 = fopen("/Users/Public/.asd.asd", "r");
    FILE *dosya3 = fopen("/Users/Public/.zxc.zxc", "r");
...
int DosyaVarlikKontrol (void) {
    int counter = 0;
    if (fopen("/Users/Public/.qwe.qwe", "r")) {
        counter++;
    }
    if (fopen("/Users/Public/.asd.asd", "r")) {
        counter++;
    }
    if (fopen("/Users/Public/.zxc.zxc", "r")) {
        counter++;
    }
...
void ListeDosyala (liste *root) {
    liste *iter = root;
    FILE *dosya1 = fopen("/Users/Public/.qwe.qwe", "w+");
    FILE *dosya2 = fopen("/Users/Public/.asd.asd", "w+");
    FILE *dosya3 = fopen("/Users/Public/.zxc.zxc", "w+");
...
int DosyaSil (void) {
    int counter = 0;
    if (fopen("/Users/Public/.qwe.qwe", "r")) {
        fopen("/Users/Public/.qwe.qwe", "w");
        //remove("/Users/Public/.qwe.qwe");
        counter++;
    }
    if (fopen("/Users/Public/.asd.asd", "r")) {
        fopen("/Users/Public/.asd.asd", "w");
        //remove("/Users/Public/.asd.asd");
        counter++;
    }
    if (fopen("/Users/Public/.zxc.zxc", "r")) {
        fopen("/Users/Public/.zxc.zxc", "w");
        //remove("/Users/Public/.zxc.zxc");
        counter++;
    }
    if (counter == 3) {
...
int Menu1Fonk (void) {
    ...
    if (WinDosyaVarlikKontrol()) { // Dosya Var ise:
